...
VNTC 2.0 APP 是一个基于 [VNT](https://github.com/vnt-dev/vnt) 的图形化虚拟组网客户端，在原有组网能力之上，进一步整合了远程协助、日志诊断、配置备份恢复等能力，目标是让普通用户也能更轻松地搭建和使用自己的虚拟局域网。
